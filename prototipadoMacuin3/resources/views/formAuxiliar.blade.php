        ...
        <div class="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
            ...
            <div id="profile"
                ...
                <div class="p-4 md:p-12 text-center lg:text-left">
                    ...
                    <br>
                    <form href="{{ route('NperfilAuxiliar') }}" method="GET">
                        @csrf
                        <label>Nombre: </label>
                        <input type="text" name="txtTitulo"></input>
                        <label>Edad: </label>
                        <input type="text" name="txtTitulo1" value="{{ old('txtTitulo1') }}"></input>
                        <label>Puesto: </label>
                        <input type="text" name="txtTitulo2" value="{{ old('txtTitulo2') }}"></input>
                        <label>Cargo: </label>
                        <input type="text" name="txtTitulo2" value="{{ old('txtTitulo3') }}"></input>
                        ...
                        <div class="pt-12 pb-8">
                            <button class="bg-blue-700 hover:bg-blue-900 text-white font-bold py-2 px-4 rounded-full"
                                type="submit" name="btn_send" id="btn_send">
                                Actualizar perfil
                            </button>
                        </div>
                    </form>
