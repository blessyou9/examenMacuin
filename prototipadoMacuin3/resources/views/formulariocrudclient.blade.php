...
<div class="container mt-5 cool-md-6">
    ...
    <div>
        <form method="post" action="{{ route('registrarclient') }}">
            @csrf
            <div>
    ...
    <div>
        ...
        <br>
        <br>
        <a class="bg-indigo-600 px-4 py-2 rounded-md text-white font-semibold tracking-wide cursor-pointer" href="/ticketscliente">Regresar</a>
    </div>
        </form>
