            ...
            <div class=" flex items-center justify-between pb-6">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex bg-gray-50 items-center p-2 rounded-md">
                        ...
                        <form method="get" action="{{ route('filtraraux') }}">
                    ...
                    <tbody>
                        ...
                        @foreach ($consultaConsultas as $consulta)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('editarticketaux', $consulta->Codigo) }}"
                                        onclick="event.preventDefault(); if(confirm('¿Estás seguro que quieres mandar observaciones a este ticket?')) { window.location.href = '{{ route('editaraux', $consulta->Codigo) }}'; }"
                                    ...
                                    <a href="{{ route('NconsultaTicketaux', $consulta->Codigo) }}"
                                    ...
                                    <form id="delete-form-{{ $consulta->Codigo }}"
                                        action="{{ route('NconsultaTicketaux', $consulta->Codigo) }}" method="POST"
                                        style="display: none;">
                                        {{ csrf_field() }}
                                        {{ method_field('DELETE') }}
                                    </form>
