...
<h1 class="mt-4 display-1 text-center">Ingrese su departamento</h1>
<br>
<div class="container mt-5 cool-md-6">
    ...
    <div>
        <form method="post" action="{{ route('registrardepa') }}">
            @csrf
            <div>
            ...
            <div>
                <label class="form-label" name="labelTitulo">Ubicacion: </label>
    ...
    <div>
        <br>
        <br>
        <a class="bg-indigo-600 px-4 py-2 rounded-md text-white font-semibold tracking-wide cursor-pointer" href="/departamentos">Regresar</a>
    </div>
        </form>
