        ...
        <div class="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
            ...
            <div id="profile"
                ...
                <div class="p-4 md:p-12 text-center lg:text-left">
                    ...
                    <h1 class="text-3xl font-bold pt-8 lg:pt-0">Elie beard</h1>
                    ...
                    <p class="pt-8 text-sm" style="color: black;">Cliente</p>
                    <p style="color: black;">
                        Adquisicion de productos o servicios.
                    </p>
                    <div class="pt-12 pb-8">
                        <a href="{{ route('NformCliente') }}"
