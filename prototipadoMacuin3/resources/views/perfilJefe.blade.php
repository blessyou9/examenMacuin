        ...
        <div class="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
            ...
            <div id="profile"
                ...
                <div class="p-4 md:p-12 text-center lg:text-left">
                    ...
                    <h1 class="text-3xl font-bold pt-8 lg:pt-0">Vera Carpenter</h1>
                    ...
                    <p style="color: black;">
                        Tengo a cargo de la identificación y seguimiento de oportunidades de ventas,
                        incluyendo la presentación de productos o servicios a clientes potenciales y
                        la elaboración de propuestas y cotizaciones.
                    </p>
                    <div class="pt-12 pb-8">
                        <a href="{{ route('NformJefe') }}"
