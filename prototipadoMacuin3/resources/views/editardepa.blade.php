...
<h1 class="mt-4 display-1 text-center">Editar departamento</h1>
<br>
<div class="container mt-5 cool-md-6">
    ...
    <div>
        <form method="post" action="{{ route('actualizardepa', $consultaid->id) }}">
            @csrf
            {!! method_field('PUT') !!}
            <div class="mb-3">
            ...
            <div class="mb-3">
                <label class="form-label" name="labelTitulo">Ubicación: </label>
                <input type="text" class="form-control" name="txtTitulo1" value="{{ $consultaid->Ubicacion }}"></input>
